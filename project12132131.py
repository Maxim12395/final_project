...
p[2,0], p[2,1], p[2,2], p[2,3] = -15, -10, 1, 6
p[3,0], p[3,1], p[3,2], p[3,3] = -15, -1, 1, 4
p[4,0], p[4,1], p[4,2], p[4,3] = -15, -5, 5, 2
p[5,0], p[5,1], p[5,2], p[5,3] = -15, -7 , 6, 5
...
mass_c = 1000
const =  8.98755 * 10**9
g = 00.00  # Ускорение свободного падения
...
ball3, = plt.plot([], [], 'o', color='b', ms=1)
ball4, = plt.plot([], [], 'o', color='k', ms=1)
ball5, = plt.plot([], [], 'o', color='y', ms=1)
ball6, = plt.plot([], [], 'o', color='c', ms=1)
...
def animate(i):
    ...
    ball5.set_data(circle_func(x[4, i], y[4, i], radius))
    ball6.set_data(circle_func(x[5, i], y[5, i], radius))
